  ...
  module Mutations
    module Products
      module YahooAuctionCrawlSettings
        class UpdateYahooAuctionCrawlSettingExcludeKeyword < Base
          ...
          type Unions::Products::YahooAuctionCrawlSettings::UpdateYahooAuctionCrawlSettingExcludeKeyword::
               UpdateYahooAuctionCrawlSettingExcludeKeywordResultUnion, null: false
          ...
          def resolve(input)
            ...
            {
              __typename: "UpdateYahooAuctionCrawlSettingExcludeKeywordResultSuccessType",
              yahoo_auction_crawl_setting_exclude_keyword:,
              ok: true
            }
          ...
          def error_response(code, message)
            {
              __typename: "UpdateYahooAuctionCrawlSettingExcludeKeywordResultErrorType",
              error: {
                __typename: "UpdateYahooAuctionCrawlSettingExcludeKeywordResultValidationFailedType",
                code:,
                message:,
                details: []
              },
