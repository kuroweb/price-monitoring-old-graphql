  ...
  module Mutations
    module Products
      module IosysCrawlSettings
        class UpdateIosysCrawlSettingExcludeKeywordMutation < Base
          ...
          type Unions::Products::IosysCrawlSettings::UpdateIosysCrawlSettingExcludeKeyword::
               UpdateIosysCrawlSettingExcludeKeywordResultUnion, null: false
          ...
          def resolve(input)
            ...
            {
              __typename: "UpdateIosysCrawlSettingExcludeKeywordResultSuccessType",
              iosys_crawl_setting_exclude_keyword:,
              ok: true
            }
          ...
          def error_response(code, message)
            {
              __typename: "UpdateIosysCrawlSettingExcludeKeywordResultErrorType",
              error: {
                __typename: "UpdateIosysCrawlSettingExcludeKeywordResultValidationFailedType",
                code:,
                message:,
                details: []
              },
