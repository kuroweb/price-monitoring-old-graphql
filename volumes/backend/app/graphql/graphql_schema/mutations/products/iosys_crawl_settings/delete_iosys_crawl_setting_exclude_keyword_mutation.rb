  ...
  module Mutations
    module Products
      module IosysCrawlSettings
        class DeleteIosysCrawlSettingExcludeKeywordMutation < Base
          ...
          type Unions::Products::IosysCrawlSettings::DeleteIosysCrawlSettingExcludeKeyword::
               DeleteIosysCrawlSettingExcludeKeywordResultUnion, null: false
          ...
          def resolve(input) # rubocop:disable Metrics/MethodLength
            ...
            if iosys_crawl_setting_exclude_keyword.destroy
              {
                __typename: "DeleteIosysCrawlSettingExcludeKeywordResultSuccessType",
                ok: true
              }
            else
          ...
          def error_response(code, message)
            {
              __typename: "DeleteIosysCrawlSettingExcludeKeywordResultErrorType",
              error: {
                __typename: "DeleteIosysCrawlSettingExcludeKeywordResultValidationFailedType",
                code:,
                message:,
                details: []
              },
