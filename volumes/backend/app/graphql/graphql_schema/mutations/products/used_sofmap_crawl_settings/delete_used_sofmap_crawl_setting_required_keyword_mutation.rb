  ...
  module Mutations
    module Products
      module UsedSofmapCrawlSettings
        class DeleteUsedSofmapCrawlSettingRequiredKeywordMutation < Base
          ...
          type Unions::Products::UsedSofmapCrawlSettings::DeleteUsedSofmapCrawlSettingRequiredKeyword::
               DeleteUsedSofmapCrawlSettingRequiredKeywordResultUnion, null: false
          ...
          def resolve(input) # rubocop:disable Metrics/MethodLength
            ...
            if used_sofmap_crawl_setting_required_keyword.destroy
              {
                __typename: "DeleteUsedSofmapCrawlSettingRequiredKeywordResultSuccessType",
                ok: true
              }
            else
          ...
          def error_response(code, message)
            {
              __typename: "DeleteUsedSofmapCrawlSettingRequiredKeywordResultErrorType",
              error: {
                __typename: "DeleteUsedSofmapCrawlSettingRequiredKeywordResultValidationFailedType",
                code:,
                message:,
                details: []
              },
