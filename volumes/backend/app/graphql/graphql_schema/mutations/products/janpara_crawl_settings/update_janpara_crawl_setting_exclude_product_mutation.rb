  ...
  module Mutations
    module Products
      module JanparaCrawlSettings
        class UpdateJanparaCrawlSettingExcludeProductMutation < Base
          ...
          type Unions::Products::JanparaCrawlSettings::UpdateJanparaCrawlSettingExcludeProduct::
               UpdateJanparaCrawlSettingExcludeProductResultUnion, null: false
          ...
          def resolve(input)
            ...
            {
              __typename: "UpdateJanparaCrawlSettingExcludeProductResultSuccessType",
              janpara_crawl_setting_exclude_product:,
              ok: true
            }
          ...
          def error_response(code, message)
            {
              __typename: "UpdateJanparaCrawlSettingExcludeProductResultErrorType",
              error: {
                __typename: "UpdateJanparaCrawlSettingExcludeProductResultValidationFailedType",
                code:,
                message:,
                details: []
              },
