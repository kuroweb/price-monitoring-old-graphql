  ...
  module Mutations
    module Products
      module PcKoubouCrawlSettings
        class CreatePcKoubouCrawlSettingExcludeKeywordMutation < Base
          ...
          type Unions::Products::PcKoubouCrawlSettings::CreatePcKoubouCrawlSettingExcludeKeyword::
               CreatePcKoubouCrawlSettingExcludeKeywordResultUnion, null: false
          ...
          def resolve(input)
            ...
            {
              __typename: "CreatePcKoubouCrawlSettingExcludeKeywordResultSuccessType",
              pc_koubou_crawl_setting_exclude_keyword:,
              ok: true
            }
          ...
          def error_response(code, message)
            {
              __typename: "CreatePcKoubouCrawlSettingExcludeKeywordResultErrorType",
              error: {
                __typename: "CreatePcKoubouCrawlSettingExcludeKeywordResultValidationFailedType",
                code:,
                message:,
                details: []
              },
