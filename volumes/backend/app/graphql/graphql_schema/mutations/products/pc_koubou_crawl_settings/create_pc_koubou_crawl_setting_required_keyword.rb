  ...
  module Mutations
    module Products
      module PcKoubouCrawlSettings
        class CreatePcKoubouCrawlSettingRequiredKeyword < Base
          ...
          type Unions::Products::PcKoubouCrawlSettings::CreatePcKoubouCrawlSettingRequiredKeyword::
               CreatePcKoubouCrawlSettingRequiredKeywordResultUnion, null: false
          ...
          def resolve(input)
            ...
            {
              __typename: "CreatePcKoubouCrawlSettingRequiredKeywordResultSuccessType",
              pc_koubou_crawl_setting_required_keyword:,
              ok: true
            }
          ...
          def error_response(code, message)
            {
              __typename: "CreatePcKoubouCrawlSettingRequiredKeywordResultErrorType",
              error: {
                __typename: "CreatePcKoubouCrawlSettingRequiredKeywordResultValidationFailedType",
                code:,
                message:,
                details: []
              },
