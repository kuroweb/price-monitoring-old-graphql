  ...
  module Mutations
    module Products
      module MercariCrawlSettings
        class DeleteMercariCrawlSettingExcludeKeywordMutation < Base
          ...
          type Unions::Products::MercariCrawlSettings::DeleteMercariCrawlSettingExcludeKeyword::
               DeleteMercariCrawlSettingExcludeKeywordResultUnion, null: false
          ...
          def resolve(input) # rubocop:disable Metrics/MethodLength
            ...
            if mercari_crawl_setting_exclude_keyword.destroy
              {
                __typename: "DeleteMercariCrawlSettingExcludeKeywordResultSuccessType",
                ok: true
              }
            else
          ...
          def error_response(code, message)
            {
              __typename: "DeleteMercariCrawlSettingExcludeKeywordResultErrorType",
              error: {
                __typename: "DeleteMercariCrawlSettingExcludeKeywordResultValidationFailedType",
                code:,
                message:,
                details: []
              },
