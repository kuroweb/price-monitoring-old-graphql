...
func (u *UpdateYahooAuctionCrawlSettingRequiredKeywordService) handleApiError(resp *http.Response) model.UpdateYahooAuctionCrawlSettingRequiredKeywordResultError {
