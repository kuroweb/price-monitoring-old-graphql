...
import { createPcKoubouCrawlSettingExcludeKeyword } from '@/features/products/server-actions/productQuery'
import { CreatePcKoubouCrawlSettingExcludeKeywordInput } from '@/graphql/dist/client'
...
const CreateForm = ({
  ...
  const onSubmit: SubmitHandler<CreatePcKoubouCrawlSettingExcludeKeywordInput> = async (data) => {
    const result = await createPcKoubouCrawlSettingExcludeKeyword(data)
