...
import { deleteUsedSofmapCrawlSettingRequiredKeyword } from '@/features/products/server-actions/usedSofmapCrawlSettingRequiredKeywordQuery'
...
const KeywordTable = ({
  ...
  const destroy = async (id: string, productId: string) => {
    const result = await deleteUsedSofmapCrawlSettingRequiredKeyword(id, productId, pathname)
