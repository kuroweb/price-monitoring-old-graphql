...
import { deletePcKoubouCrawlSettingExcludeProduct } from '@/server-actions/pcKoubouCrawlSettingExcludeProductQuery'
  ...
  return (
    <>
      <table className='table'>
        ...
        <tbody>
          {data.product.pcKoubouCrawlSetting.pcKoubouCrawlSettingExcludeProducts.map(
            (condition) => (
              <tr key={condition.id}>
