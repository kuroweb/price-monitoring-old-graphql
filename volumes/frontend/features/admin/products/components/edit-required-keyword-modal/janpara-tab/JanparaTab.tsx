...
const JanparaTab = ({ data }: { data: AdminProductsIdPageDataQuery }) => {
  const [mode, setMode] = useState<'list' | 'create' | 'edit'>('list')
  const [condition, setCondition] = useState<JanparaCrawlSettingRequiredKeyword | undefined>(
    undefined,
  )
