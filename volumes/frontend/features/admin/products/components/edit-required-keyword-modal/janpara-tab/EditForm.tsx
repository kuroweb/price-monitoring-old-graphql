...
import { updateJanparaCrawlSettingRequiredKeyword } from '@/server-actions/janparaCrawlSettingRequiredKeywordQuery'
...
function EditForm({
  ...
  condition: JanparaCrawlSettingRequiredKeyword | undefined
}) {
  ...
  const { register, handleSubmit } = useForm<UpdateJanparaCrawlSettingRequiredKeywordInput>({
    defaultValues: {
